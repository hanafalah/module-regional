...
namespace Hanafalah\ModuleRegional\Facades;
 ...
 */
class ModuleRegional extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleRegional\Contracts\ModuleRegional::class;
  }
}
